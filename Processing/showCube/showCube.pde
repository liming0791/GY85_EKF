...
final String serialPort = "/dev/ttyACM1"; // replace this with your serial port. On windows you will need something like "COM1".
...
void draw() {
  ...
  text("nYaw (psi)  : " + degrees(Euler[2]), 20, 20);
  text("nPitch (theta): " + degrees(Euler[1]), 20, 40);
  text("nRoll (phi)  : " + degrees(Euler[0]), 20, 60);
